...
namespace WebApi.Services
{
    ...
    public class UserService : IUserService
    {
        ...
        public User Create(UserRequest user)
        {
            ...
            _loggerService.LogMessage($"El usuario {UserLogged.userLogged.Usuario} creó al usuario {user.Usuario}", UserLogged.userLogged.Usuario, _context, null);
        ...
        public int Update(int id, UserRequest user)
        {
            ...
            _loggerService.LogMessage($"El usuario {UserLogged.userLogged.Usuario} modificó al usuario {user.Usuario}", UserLogged.userLogged.Usuario, _context, null);
